...
var DetailsComponent = /** @class */ (function () {
    function DetailsComponent(studentService) {
        this.studentService = studentService;
    }
    DetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.studentService.students.subscribe(function (val) {
            _this.students = val;
        });
    };
...
var InputformComponent = /** @class */ (function () {
    function InputformComponent(router, formBuilder, studentService) {
        this.router = router;
    ...
    Object.defineProperty(InputformComponent.prototype, "studentForm", {
    ...
    InputformComponent.ctorParameters = function () { return [
...
var StudentService = /** @class */ (function () {
    ...
    StudentService.prototype.getStudentsFromJSON = function () {
        var _this = this;
        this.http.get('assets/students.json').subscribe(function (data) {
            _this.students.next(data);
        });
    };
    StudentService.prototype.addValue = function (student) {
        this.students.next(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.students.getValue(), [student]));
